...
test( 'the `image` field corresponds to a shields.io badge url', function test( t ) {
	...
	t.equal( out.image, 'https://img.shields.io/npm/v/beep.svg?style=flat', 'image url' );
	t.end();
});
...
test( 'the badge style can be specified', function test( t ) {
	...
	t.equal( out.image, 'https://img.shields.io/npm/v/beep.svg?style=flat-square', 'image url' );
	t.end();
});
...
test( 'the badge format can be specified', function test( t ) {
	...
	t.equal( out.image, 'https://img.shields.io/npm/v/beep.png?style=flat', 'image url' );
	t.end();
});
